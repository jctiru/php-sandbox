            ...
            <div class="col-lg-3 col-md-6 col-12 mt-3 mb-3 d-flex">
                <div class="card mb-xs-5 mt-xs-5">
                    ...
                    <div class="card-footer">
                        ...
                        <button data-index="<?php echo $index ?>" data-toggle="modal" data-target="#exampleModal" class="btn btn-block btn-primary mr-1 modalButton">Edit/Delete</button>
                        <?php else: ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div id="modalBody" class="modal-body">
                	<img  id="modalItemImage" style="width: 100%;" src="">
